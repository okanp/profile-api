...
class ProfileApplicationIT {
    ...
    void should_save_profile() throws Exception {
        ...
        pd1.setName("okan");
        pd1.setGender(Gender.MALE);
        pd1.setBirthday(ZonedDateTime.parse("1893-05-30T11:15:30+02:00[Europe/Amsterdam]"));
    ...
    void should_calculate_candidates_for_the_profile() throws Exception {
        ...
        p1.getPreference().setGender(Gender.FEMALE);
        profileRepository.save(p1);
        ...
        p2.getPreference().setGender(Gender.MALE);
        profileRepository.save(p2);
        ...
        p3.getPreference().setGender(Gender.FEMALE);
        profileRepository.save(p3);

        assertThat(candidateRepository.count(), is(0L));
        ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders
                .get("/v1/candidate/profile/" + p1.getId().toString() + "/trigger"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(print());
    ...
    void should_find_candidates_for_profile_by_status() throws Exception {
        ...
        candidate2.setProfileA(p3);
        candidate2.setProfileB(p2);
        candidate2.setStatus(CandidateStatus.NO_MATCH);
        candidateRepository.save(candidate2);

        ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders
                .get("/v1/candidate/profile/" + p2.getId().toString()).param("status", String.valueOf(CandidateStatus.NO_MATCH)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(print());
    ...
    void should_swipe_the_candidate() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                .post("/v1/candidate/" + candidate.getId() + "/profile/" + p1.getId().toString() + "/swipe").param("response", String.valueOf(CandidateResponse.DISLIKE)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(print())
                .andReturn();

        Candidate candidate1 = candidateRepository.findOneById(candidate.getId());
        assertThat(CandidateStatus.NO_MATCH, is(candidate1.getStatus()));
        assertThat(CandidateResponse.DISLIKE, is(candidate1.getProfileAResponse()));
    ...
    void should_swipe_the_candidate_to_match() throws Exception {
        ...
        candidate.setProfileA(p1);
        candidate.setProfileB(p2);
        candidate.setProfileAResponse(CandidateResponse.LIKE);
        candidateRepository.save(candidate);

        mockMvc.perform(MockMvcRequestBuilders
                .post("/v1/candidate/" + candidate.getId() + "/profile/" + p2.getId().toString() + "/swipe").param("response", String.valueOf(CandidateResponse.SUPER_LIKE)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(print())
                .andReturn();

        Candidate candidate1 = candidateRepository.findOneById(candidate.getId());
        assertThat(CandidateStatus.MATCH, is(candidate1.getStatus()));
        assertThat(CandidateResponse.LIKE, is(candidate1.getProfileAResponse()));
